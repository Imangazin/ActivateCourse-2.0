...
session_set_cookie_params(
    ...
    '/BLE/ActivateCourse/; samesite=None',
    $cookie_domain,
    "1",
    "1"
);
...
if($lti_auth['key'] == $context->info['oauth_consumer_key']){
        ...
        echo 'LTI credentials not valid. Please refresh the page and try again. If you continue to receive this message please contact <a href="mailto:'.$supportEmail.'?Subject=Activate LTI Widget Issue" target="_top">'.$supportEmail.'</a>';
}
